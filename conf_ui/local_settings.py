...
DEBUG = False
# DISABILITA IL BLOCCO DI SICUREZZA PER HTTP
...
# Ensure WEBSSO_KEYSTONE_URL is set correctly for local environment
WEBSSO_KEYSTONE_URL = "http://localhost:5000/v3"
